...
class _MyAppState extends State<CreateScreen> {
  List<Album>? _albums = [];
  bool _loading = false;
  ...
  Future<void> initAsync() async {
    try {
      _file = await PhotoGallery.getFile(mediumId: widget.mediumId);
                      ...
                      var vf=await getTemporaryDirectory();
                      var thumbpath=vf.path+"upload.mp4";
     _file=await _file?.copy(thumbpath);
                    ...
                    onPressed: () async {
                      ...
                      await VideoThumbnail.thumbnailFile(
                        ...
                        quality: 9,
                          ...
                          (value) => Navigator.of(context).push(Routes.createRoute(_file!,value.toString())));
                      // .whenComplete(() =>  ;
                    },
